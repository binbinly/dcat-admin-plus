...
namespace AdminPlus\Http\Middleware;

use Dcat\Admin\Admin;
use AdminPlus\Models\OperationLog as OperationLogModel;
...
class LogOperation
{
    ...
    protected array $except = ['auth/operation-logs*'];
    ...
    {
        return AdminPlusServiceProvider::setting($key, $default);
    }
